...
namespace musicCatalogDotNetAPI.Migrations
{
    ...
    [Migration("20231211082003_TryRemoveTestUsersFromInit")]
    partial class TryRemoveTestUsersFromInit
    {
            ...
            modelBuilder.Entity("musicCatalogDotNetAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            CreatedAt = new DateTime(2023, 12, 11, 9, 20, 3, 79, DateTimeKind.Local).AddTicks(522),
