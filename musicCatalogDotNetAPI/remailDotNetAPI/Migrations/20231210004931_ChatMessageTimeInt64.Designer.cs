...
namespace musicCatalogDotNetAPI.Migrations
{
    ...
    [Migration("20231210004931_ChatMessageTimeInt64")]
    partial class ChatMessageTimeInt64
    {
            ...
            modelBuilder.Entity("musicCatalogDotNetAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            CreatedAt = new DateTime(2023, 12, 10, 1, 49, 30, 716, DateTimeKind.Local).AddTicks(633),
                        ...
                        {
                            UserId = 2,
                            CreatedAt = new DateTime(2023, 12, 10, 1, 49, 30, 716, DateTimeKind.Local).AddTicks(744),
